...
// return the sine ans cosine function of x in radians
template<class Val, int Bits, class Simd_tag>
void
sincos_simpl(const simd<Val, Bits, Simd_tag>& x, simd<Val, Bits, Simd_tag>& ret_sin,
    simd<Val, Bits, Simd_tag>& ret_cos);
