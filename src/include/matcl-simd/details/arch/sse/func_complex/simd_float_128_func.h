...
struct simd_compl_reverse<float, 128, sse_tag>
{
    ...
    {
        return simd_type(_mm_shuffle_ps(x.data.data, x.data.data, _MM_SHUFFLE(1,0,3,2)));
    };
};
...
struct simd_compl_plus<float, 128, sse_tag>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        return simd_type(_mm_add_ps( x.data.data, y.data.data ));
    };
};
...
struct simd_compl_minus<float, 128, sse_tag>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        return simd_type(_mm_sub_ps( x.data.data, y.data.data ));
    };
};
...
struct simd_compl_uminus<float, 128, sse_tag>
{
    ...
    static simd_type eval(const simd_type& x)
    {
        ...
        return simd_type(_mm_xor_ps( x.data.data, mzero.data));
    };
};
