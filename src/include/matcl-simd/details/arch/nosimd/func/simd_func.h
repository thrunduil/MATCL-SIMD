...
{
    using simd_type = simd<T, Bits, nosimd_tag>;
    using base_type = simd_bool_base<T>;
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        T val_true  = base_type::get_val_true();

        for (int i = 0; i < vector_size; ++i)
            res.data[i] = (x.data[i] == y.data[i]) ? val_true : base_type::val_false;
...
struct simd_lt<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        const T val_true  = base_type::get_val_true();

        for (int i = 0; i < vector_size; ++i)
            res.data[i] = scalar_func::lt(x.data[i], y.data[i]) ? val_true : base_type::val_false;
...
struct simd_gt<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        for (int i = 0; i < vector_size; ++i)
            res.data[i] = scalar_func::gt(x.data[i], y.data[i]) ? val_true : base_type::val_false;
...
struct simd_leq<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        for (int i = 0; i < vector_size; ++i)
            res.data[i] = scalar_func::leq(x.data[i], y.data[i]) ? val_true : base_type::val_false;
...
struct simd_geq<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        for (int i = 0; i < vector_size; ++i)
            res.data[i] = scalar_func::geq(x.data[i], y.data[i]) ? val_true : base_type::val_false;
...
struct simd_is_nan<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x)
    {
        ...
        for (int i = 0; i < vector_size; ++i)
            res.data[i] = matcl::simd::scalar_func::is_nan(x.data[i]) ? val_true : base_type::val_false;
...
struct simd_is_finite<T, Bits, nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x)
    {
        ...
        for (int i = 0; i < vector_size; ++i)
            res.data[i] = matcl::simd::scalar_func::is_finite(x.data[i]) ? val_true : base_type::val_false;
