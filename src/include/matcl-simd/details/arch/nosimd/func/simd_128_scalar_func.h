...
struct simd_eeq<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        ...
        return simd_type((x.data == y.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_lt<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(scalar_func::lt(x.data, y.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_gt<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(scalar_func::gt(x.data, y.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_leq<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(scalar_func::leq(x.data, y.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_geq<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(scalar_func::geq(x.data, y.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_is_nan<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(matcl::simd::scalar_func::is_nan(x.data) ? val_true : base_type::val_false);
    };
};
...
struct simd_is_finite<T, Bits, scalar_nosimd_tag> : simd_bool_base<T>
{
    ...
    {
        T val_true  = base_type::get_val_true();
        return simd_type(matcl::simd::scalar_func::is_finite(x.data) ? val_true : base_type::val_false);
    };
};
