...
struct simd_compl_reverse<float, 256, avx_tag>
{
    ...
    static simd_type eval(const simd_type& x)
    {
            ...
            return simd_type(_mm256_permutevar8x32_ps(x.data.data, control));
        #else
...
struct simd_compl_plus<float, 256, avx_tag>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        return simd_type(_mm256_add_ps( x.data.data, y.data.data ));
    };
};
...
struct simd_compl_minus<float, 256, avx_tag>
{
    ...
    static simd_type eval(const simd_type& x, const simd_type& y)
    {
        return simd_type(_mm256_sub_ps( x.data.data, y.data.data ));
    };
};
...
struct simd_compl_uminus<float, 256, avx_tag>
{
    ...
    static simd_type eval(const simd_type& x)
    {
        ...
        return simd_type(_mm256_xor_ps(x.data.data, mzero.data));
    };
};
