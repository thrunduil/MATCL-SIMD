...
template<>
class alignas(16) simd<double, 128, scalar_sse_tag>
{
    public:
        // implementation type
        ...
        using simd_half     = simd<double, 128, scalar_sse_tag>;
        ...
        using simd_vector    = simd<double, 128, sse_tag>;
    ...
    public:
        ...
        // copy constructor
        simd(const simd<double, 128, scalar_sse_tag>& s) = default;
