...
template<>
class alignas(16) simd<int32_t, 128, scalar_sse_tag>
{
    public:
        // implementation type
        ...
        using simd_half     = simd<int32_t, 128, scalar_sse_tag>;
        ...
        using simd_vector    = simd<int32_t, 128, sse_tag>;
    ...
    public:
        ...
        // copy constructor
        simd(const simd<int32_t, 128, scalar_sse_tag>& s) = default;
