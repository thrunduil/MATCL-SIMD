...
template<>
class alignas(16) simd<int32_t, 128, nosimd_tag>
{
    public:
        // implementation type
        using impl_type     = int32_t[4];
        ...
        using simd_int64_2  = simd<int64_t, 256, nosimd_tag>;
    ...
    public:
        ...
        // copy constructor
        simd(const simd<int32_t, 128, nosimd_tag>& s) = default;
