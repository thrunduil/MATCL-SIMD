...
template<>
class alignas(32) simd<int64_t, 256, nosimd_tag>
{
    public:
        // implementation type
        using impl_type     = int64_t[4];
    ...
    public:
        ...
        // conversion between simd types
        explicit simd(const simd<int64_t, 256, avx_tag>& s);
      #endif
        ...
        // copy constructor
        simd(const simd<int64_t, 256, nosimd_tag>& s) = default;
