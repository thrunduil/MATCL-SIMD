...
//-------------------------------------------------------------------
//                          GENERIC SCALAR FLOAT
//-------------------------------------------------------------------

// vector of one single precision scalar
template<>
class alignas(float) simd<float, 128, scalar_nosimd_tag>
{
    public:
        // implementation type
        using impl_type     = float;
        ...
        using simd_half     = simd<float, 128, scalar_nosimd_tag>;
        ...
        using simd_vector    = simd<float, 128, nosimd_tag>;
    ...
    public:
        ...
        // copy constructor
        simd(const simd<float, 128, scalar_nosimd_tag>& s) = default;
